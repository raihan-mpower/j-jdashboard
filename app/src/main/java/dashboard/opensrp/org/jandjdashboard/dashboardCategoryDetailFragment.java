 ...
 * on handsets.
 */
public class dashboardCategoryDetailFragment extends Fragment {
    /**
     ...
     */
    public dashboardCategoryDetailFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.dashboardcategory_detail, container, false);

        // Show the dummy content as text in a TextView.
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.dashboardcategory_detail)).setText(mItem.details);
        }
